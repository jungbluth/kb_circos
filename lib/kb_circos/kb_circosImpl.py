...
class kb_circos:
    ...
    ######################################### noqa
    VERSION = "1.0.0"
    GIT_URL = "https://github.com/jungbluth/kb_circos"
    ...
    def run_kb_circos(self, ctx, params):
        """
        :param params: instance of type "CircosInputParams" (required
        ...
        :returns: instance of type "CircosResult" (result_folder: folder
           path that holds all files generated by run_kb_circos report_name:
        ...
        circos_runner = CircosUtil(self.config)

        returnVal = circos_runner.run_circos(params)

        #END run_kb_circos

        # At some point might do deeper type checking...
        if not isinstance(returnVal, dict):
            raise ValueError('Method run_kb_circos return value ' +
